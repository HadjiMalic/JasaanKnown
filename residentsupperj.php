            ...
            <?php if ($result->num_rows > 0) : ?>
                <?php while ($row = $result->fetch_assoc()) : ?>
                    <tr>
                        ...
                        <td>
                            <a href='editR.php?id=<?php echo $row["id"]; ?>' class='edit-btn'><i class='bx bx-edit'></i></a>
                            <a href='?action=delete&id=<?php echo $row["id"]; ?>' class='delete-btn' onclick='return confirm("Are you sure you want to delete this resident?")'><i class='bx bx-trash'></i></a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else : ?>
