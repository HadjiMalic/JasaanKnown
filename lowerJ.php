...
<table class="content-table" style="border-collapse: collapse; width: 100%;">
    <tr>
        <td style="padding: 10px; background-image: url('images/pmlj.jpg'); background-size: contain; background-position: center top;">
            <div style="color:black; text-align: center; font-size: 50px; font-weight: bold; padding: 50px; background-color: rgba(255, 255, 255, 0.5); border-radius: 15px;">
                WELCOME TO LOWER JASAAN
            </div>
        </td>
    </tr>
</table>
    ...
    // Redirect to popLJ.php
    window.location.href = 'popLJ.php';
}
